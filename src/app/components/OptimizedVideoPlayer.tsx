...
export function OptimizedVideoPlayer({ videoUrl, videoId, isActive, filterName = 'none', username, userAvatar, caption }: any) {
 ...
 return (
  <div className="relative w-full h-screen bg-black flex items-center justify-center overflow-hidden">
   ...
   {/* 🔥 INFO OVERLAY (Latest Profile & Name) */}
   <div className="absolute bottom-20 left-4 z-30 pointer-events-none max-w-[80%]">
      <div className="flex items-center gap-3 mb-2 pointer-events-auto">
        ...
        <span className="text-white font-black italic text-lg tracking-tighter drop-shadow-md">
          @{username || 'user'}
        </span>
      </div>
