        ...
        <div className="flex items-center gap-3">
          {currentUser ? (
            ...
            <button 
              ...
              className="px-4 py-1.5 bg-blue-600 text-white rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg active:scale-95 transition-all"
            >
              Sign In
            </button>
          )}
