...
// --- FONT STYLES WITH PROFESSIONAL BACKGROUND VARIATIONS ---
const FONT_STYLES = [
...
export default function CreatePage() {
          ...
          <div key={i} className="relative w-full h-full bg-zinc-900 overflow-hidden border-[0.5px] border-white/5">
            {isLive ? (
              ...
              <div className="w-full h-full relative">
                ...
                {/* 🚀 PROBLEM 6 FIX: Draggable caption node stack decoupled entirely from video scales to preserve font axis mapping */}
                {i === 0 && (
                    ...
                    {textOverlays.map(t => (
                      ...
                      >
                        <div className="relative flex items-center justify-center">
                          ...
                          {/* 🚀 Hover Action controls layout framework module for click adjustments */}
                          <div className="absolute -top-12 bg-black/90 px-2 py-1 border border-white/10 rounded-xl flex gap-3 opacity-0 group-hover:opacity-100 transition-opacity backdrop-blur-xl z-[400]">
                            ...
                            <button onClick={(e) => { e.stopPropagation(); setTextOverlays(textOverlays.filter(x => x.id !== t.id)); }} className="text-red-500 p-1 hover:bg-white/10 rounded-md transition-colors">
                              <Trash2 size={14}/>
                            </button>
                          </div>
                        </div>
  ...
  return (
    ...
    >
      ...
      {/* --- ENHANCED TEXT OVERLAY EDITOR (PROBLEM 6 FIX: ADVANCED SIZE ADJUSTMENT / MUTATION PANEL) --- */}
      {isAddingText && (
