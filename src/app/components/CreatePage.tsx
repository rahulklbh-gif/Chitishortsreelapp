...
export function CreatePage() {
  ...
  // Browser-native Thumbnail Generator (No FFmpeg needed)
  ...
  const handleUpload = async () => {
    if (!selectedFile || !user) return toast.error("Please login and select a video.");
    setIsUploading(true);
    const toastId = toast.loading('Uploading direct to R2...');
    ...
    try {
      ...
      // 3. Supabase Record (Fixing Profile Pic and Video Play)
  ...
  if (!user) return <div className="text-white text-center mt-20 font-bold">Please Login</div>;
      ...
      {!selectedFile ? (
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="space-y-2">
            <p className="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1">Filters</p>
          ...
          <textarea 
            ...
            className="w-full bg-gray-900 p-5 rounded-[24px] outline-none border border-gray-800 focus:border-blue-500"
            value={caption}
