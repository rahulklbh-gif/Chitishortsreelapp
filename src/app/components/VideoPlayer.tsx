    ...
    try {
      ...
      await Promise.all([
        supabase.from('posts').insert([{ 
          ...
          filter_name: selectedFilter // Sirf filter ka naam save hoga
        }]),
            ...
            <div className="flex-1 p-6 flex flex-col bg-black">
              ...
              {isUploading && (
                <div className="mb-10 space-y-2">
                   <div className="flex justify-between items-end text-[9px] font-black text-blue-500 uppercase italic"><span>Uploading...</span><span>{uploadProgress}%</span></div>
